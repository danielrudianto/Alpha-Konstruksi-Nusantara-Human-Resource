...
router.get("/", authorization_middleware_1.default.intercept, test_controller_1.default.fetchByToken);
router.post("/end", authorization_middleware_1.default.intercept, test_controller_1.default.endByToken);
